            ...
            >
                <div className="flex items-start justify-between gap-4">
                    <div>
                        ...
                        <h2 id="edit-flashcard-title" className="mt-3 font-serif-display text-4xl tracking-[-0.03em] text-[#1A1A1A]">Editar flashcard</h2>
                        <p className="mt-3 text-sm leading-7 text-[#5A5A52]">Atualize a pergunta e resposta da flashcard.</p>
                    </div>
