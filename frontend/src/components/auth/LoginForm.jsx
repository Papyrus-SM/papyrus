        ...
        <div className="w-full max-w-md rounded-2xl border border-[#E8E8DF] bg-white/70 p-8 shadow-sm backdrop-blur-sm">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                    type="submit"
                    disabled={loading}
                    className="w-full rounded-xl border border-[#1A1A1A] bg-[#1A1A1A] px-8 py-3.5 text-[15px] font-medium tracking-[0.01em] text-[#FAFAF7] transition duration-200 hover:-translate-y-px hover:bg-[#2E2E2E] disabled:cursor-not-allowed disabled:opacity-70"
                >
                ...
                <a
                    href="/register"
                    className="block w-full rounded-xl border border-[#CBCBC2] bg-transparent px-8 py-3.5 text-center text-[15px] font-normal tracking-[0.01em] text-[#1A1A1A] transition duration-200 hover:-translate-y-px hover:border-[#1A1A1A] hover:bg-[#F0F0E8]"
                >
                    Criar conta
                </a>
            </form>
